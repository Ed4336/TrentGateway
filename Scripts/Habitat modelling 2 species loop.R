...
species.list <- c('Salmo salar', 'Salmo trutta', 'Anguilla anguilla', 'Lampetra fluviatilis', 'Petromyzon marinus', 'Alosa alosa', 'Alosa fallax', 'Osmerus eperlanus', 'Acipenser sturio', 'Acipenser oxyrinchus')
...
for (species.name in species.list) {
  ...
  # Save results
  output_filename <- file.path("Data", "Outputs", paste0(species.name, "_model.tif"))
