...
for (species.name in species.list) {
  ...
  occurrence_filepath <- file.path("Data", "Outputs", paste0(species.name, "occurrences.csv")) 
  ...
  occurrence_clean_filepath <- file.path("Data", "Outputs", "Models", "Special Interest", paste0(species.name, "cleaned_occurrences.csv")) 
  ...
  # Save results
  output_filename <- file.path("Data", "Outputs", "Models", "Special Interest", paste0(species.name, "_model.tif"))
